...
const CourseDetails = () => {
  ...
  useEffect(() => {
    if (userData && courseData) {
      ...
      // const enrolledCourses = userData.enrolledCourse || [];
      // setIsAlreadyEnrolled(enrolledCourses.includes(courseData._id));
    }
  }, [userData, courseData]);
  ...
  return courseData ? (
    <>
      <div className="flex flex-col-reverse md:flex-row gap-10 relative items-start justify-between px-8 md:px-36 md:pt-30 pt-20 text-left">
        ...
        <div className="z-10 bg-white rounded-2xl shadow-lg overflow-hidden min-w-[320px] sm:min-w-[420px] max-w-md mx-auto">
          {playerData ? (
            <YouTube
            ...
            <img
              ...
              className="w-120 h-100 space-x-2 mx-auto object-cover rounded-lg shadow-md"
            />
          )}
          ...
          <div className="p-5 flex items-center">
            ...
            <p className="text-sm text-red-600">
              <span className="font-medium pl-3">5 days</span> left at this
              price
            </p>
          </div>

          <div className="flex gap-3 items-center pt-2 p-5">
